...
function onMessage(evt) {
  ...
  const wallet = JSON.parse(mensaje).wallet
  console.log("mensaje?", wallet);
  // Agregamos al textarea el mensaje recibido
  // var area = document.getElementById("mensajes");
  // area.innerHTML += evt.data + "\n";

  var public = document.getElementById("public-key");
  public.innerHTML += wallet.publicKey + "\n";

  var private = document.getElementById("private-key");
  private.innerHTML += wallet.privateKey + "\n";
}
